...
const Playlist = ({songs, likedcheck, setLikedcheck, mostplayed}) => {
  ...
  return (
    <div className={styles.tableWrapper}>
      <table className={styles.table}>
        ...
        {songs.map(song => {
          return <TableRow key={song.id} props={song.account} likedcheck={likedcheck} setLikedcheck={setLikedcheck}/>
        })}
      </table>
    </div>
  )
